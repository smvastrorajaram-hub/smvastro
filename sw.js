const CACHE_NAME='smv-astro-en-20260910b';
const APP_SHELL=['./index.html','./legacy.css?v=20260910b','./interface.css?v=20260910b','./interface.js?v=20260910b','./app.mjs?v=20260910b','./public-content.mjs?v=20260910b','./admin-workflows.mjs?v=20260910b','./manifest.webmanifest','./assets/icon-192.png','./assets/icon-512.png'];
