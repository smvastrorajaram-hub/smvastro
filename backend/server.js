...
app.post("/submit-answer", async (req, res) => {
  ...
  try {
    ...
    // Preserve the submitted answer language on this bilingual site.
    // The original validation above remains unchanged; only the stored answer
    // is retained in its original language.
...
app.post("/admin/takeover-answer", express.json({limit:"30kb"}), async (req,res)=>{
  ...
  try{
    ...
    // Preserve the Admin answer language for both website languages.
    const translatedAnswer=answer;
